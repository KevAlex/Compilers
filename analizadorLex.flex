...
--
/* ComiSimple */
( '\'' ) {lexeme=yytext(); return ComiSimple;}

/* Tipos de datos */
( byte | int | char | long | float | double | unsigned ) {lexeme=yytext(); return T_dato;}


---
/* Privacidad */
( private | public | protected ) {lexeme=yytext(); return P_dato;}
